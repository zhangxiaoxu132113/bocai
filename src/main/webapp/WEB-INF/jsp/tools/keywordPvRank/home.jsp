...
<head>
    ...
    <script type="text/javascript" src="<%=path%>/js/tools/keywordRankPv.js"></script>
    <script type="text/javascript">
        $(function () {
            ...
            task_name_tooltip_content += '<tr><td>请先检查搜索词日期当天是否有百度关键词统计数据</td></tr>';
            task_name_tooltip_content += '<tr><td stype=\"text-align:center\">不选择，则默认前两天的百度统计数据</td></tr>';
...
<jsp:include page="../keywordPvRank/dialog.jsp"/>
