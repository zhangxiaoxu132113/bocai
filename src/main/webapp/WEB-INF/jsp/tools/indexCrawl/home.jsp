        ...
        <div class="search-div" style="overflow: auto; width: 1150px">
            <table class="table-search" width="auto;">
                <tr>
                    ...
                    <td>
                        <input id="execute_type" name="type" class="easyui-combobox" valueField="id"
                               textField="text" panelHeight="auto" style="width:100px;" />
                    </td>
                    <td>
                        <label>执行状态：</label>
                    </td>
                    ...
                    <td>
                        <a class="easyui-linkbutton" iconCls="icon-edit" onclick="checkTaskExecutetatus()">查看运行状态</a>
                    </td>
                </tr>
            </table>
        </div>
