...
<head>
    ...
    <script type="text/javascript" src="<%=path%>/js/task/tab1.js"></script>
...
<div id="top" region="north" border="false" style="overflow: auto;">
    <form id="searchForm">
        ...
        <table class="table-search" width="auto;" style="overflow: auto; width: 900px">
            <tr>
                ...
                <td><label>指标：</label></td>
                <td>
                    <input id="rank" name="rank" class="easyui-combobox" valueField="id" textField="text"
