...
<head>
    ...
    <script type="text/javascript" src="<%=path%>/js/task/tab3.js"></script>
...
<div id="top" region="north" border="false" style="overflow: auto;">
    <form id="searchForm">
        ...
        <table class="table-search" width="auto;" style="overflow: auto; width: 850px">
            <tr>
                ...
                <td>
                    <input id="site_id" name="siteId" class="easyui-combobox" valueField="id"
                           textField="text"
