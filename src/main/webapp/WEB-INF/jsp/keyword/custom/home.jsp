...
<head>
    ...
    <script type="text/javascript" src="<%=path%>/js/keyword/custom.js"></script>
        ...
        <div class="search-div" style="overflow: auto; width: 1000px">
            ...
            <table class="table-search" width="auto;">
                <tr>
                    ...
                    <%--<td>
                        <a class="easyui-linkbutton" iconCls="image-custom" onclick="showOperateDiv()">定制筛选</a>
                    </td>--%>
                    <td>
                        <a class="easyui-linkbutton" iconCls="image-intro" onclick="showTips()">定制说明</a>
                    </td>
                    <td>
            ...
            <table id="table1" class="table-search" width="auto;" style="display: none">
                <tr>
                    <td>
                        <label>导出条目数量：</label>
                    </td>
                    <td>
                        <input style="width: 100px" id="exportCount" name="exportCount" class="easyui-numberbox" type="text" min="1"/>
                    </td>
                    ...
                    <td>
                        <a class="easyui-linkbutton" iconCls="icon-search" onclick="doSearch()">定制查询</a>
                    </td>
                    <td>
                        <a class="easyui-linkbutton" iconCls="image-excel" onclick="exportKeywordsForChat()">定制导出</a>
                    </td>
                </tr>
            </table>

            <table id="table2" class="table-search" width="auto;">
            </table>
        </div>
    </form>
</div>
