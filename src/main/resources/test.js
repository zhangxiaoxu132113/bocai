webpackJsonp([1], [function (e, exports, t) {
    ...
    angular.module("Controllers", []), t(278), t(279), t(280), t(282), t(283), t(285), t(286), t(287), t(288), t(289), t(290), t(291), angular.module("Services", []), t(292), t(293), t(294), t(295), t(296), t(297), t(298), t(299), t(300), t(301), t(302), t(303), t(304), t(305), t(306), t(307), t(308), t(309), t(310), t(311), angular.module("Directives", []), t(312), t(313), t(314), t(315), t(316), t(317), t(318), t(319), t(320), t(321), t(322), t(323), t(324), t(325), t(326), t(327), t(328), t(329), t(330), t(331), t(332), t(333), t(334), t(335), t(336), angular.module("Filters", []), t(338), t(339), function () {
        ...
        function r(t, a) {
            ...
            var r, s, l, d, f, u = 1732584193, m = -271733879, g = -1732584194, p = 271733878;
                ...
                views: {
                    ...
                    contentView: {
                        ...
                        controller: ["$scope", "$stateParams", "subscribeMsgService", "mmpop", function (e, t, a, n) {
                            if (t.readItem)r = e.readItem = t.readItem; else {
        ...
        location.href.indexOf("dev.web") < 0 ? angular.module("exceptionOverride", []).factory("$exceptionHandler", [function () {
            ...
            function T() {
                t.isLoaded = !0, t.isUnLogin = !1, M.report(M.ReportType.timing, {timing: {initStart: Date.now()}}), s.init().then(function (n) {
                    ...
                    f.setUserInfo(n.User), f.setSkey(n.SKey), f.setSyncKey(n.SyncKey), d.addContact(n.User), d.addContacts(n.ContactList), u.initChatList(n.ChatSet), u.notifyMobile(f.getUserName(), m.StatusNotifyCode_INITED), b.init(n.MPSubscribeMsgList), e.$broadcast("root:pageInit:success"), h.setCheckUrl(f), h.log("getUserInfo", f.getUserInfo()), t.$broadcast("updateUser"), M.report(M.ReportType.timing, {timing: {initEnd: Date.now()}});
            ...
            t.search = function (e) {
                I && a.cancel(I), I = a(function () {
                    return t.keyword ? (P && P.close(), void(P = r.open({
                        ...
                        scope: {
                            keyword: t.keyword, allContacts: w(), heightCalc: function (e) {
                ...
                switch (c.code) {
                    case 200:
                        t.newLoginPage(c.redirect_uri).then(function (t) {
                            var i = t.match(/<ret>(.*)<\/ret>/), o = t.match(/<script>(.*)<\/script>/), c = t.match(/<skey>(.*)<\/skey>/), r = t.match(/<wxsid>(.*)<\/wxsid>/), s = t.match(/<wxuin>(.*)<\/wxuin>/), l = t.match(/<pass_ticket>(.*)<\/pass_ticket>/), d = t.match(/<message>(.*)<\/message>/), f = t.match(/<redirecturl>(.*)<\/redirecturl>/);
                        ...
                        break;
                    case 201:
                        e.isScan = !0, n.report(n.ReportType.timing, {timing: {scan: Date.now()}}), t.checkLogin(e.uuid).then(i, function (t) {
            ...
            function o() {
                t.getUUID().then(function (o) {
                    ...
                    n.report(n.ReportType.timing, {timing: {qrcodeStart: Date.now()}}), setTimeout(function () {
                        c || n.report(n.ReportType.picError, {text: "qrcode can not load", src: e.qrcodeUrl})
                    }, 3e3), e.qrcodeLoad = function () {
                        c = !0, n.report(n.ReportType.timing, {timing: {qrcodeEnd: Date.now()}})
    ...
    !function () {
        ...
        angular.module("Controllers").controller("contentChatController", ["$scope", "$timeout", "$state", "$log", "$document", "$compile", "chatFactory", "accountFactory", "contactFactory", "appFactory", "confFactory", "utilFactory", "chatroomFactory", "mmpop", "ngDialog", "preview", "reportService", "mmHttp", "emojiFactory", function (e, a, n, i, o, c, r, s, l, d, f, u, m, g, p, h, M, v, y) {
            ...
            e.$on("onScroll", function (t, a) {
                ...
                var c = angular.element(window), r = 230, d = 360, u = c.width(), m = c.height(), h = t.pageY, M = t.pageX;
                ...
                $("#prerender").append(o), function (t, a, n, i) {
                    setTimeout(function () {
                        ...
                        if (n.MsgType == f.MSGTYPE_EMOTICON || n.MsgType == f.MSGTYPE_IMAGE || n.MsgType == f.MSGTYPE_VIDEO) {
                            t.$digest();
                            var r = a.find(".content .msg-img"), s = r.height(), l = {};
                            if (n.ImgHeight)n.MsgType == f.MSGTYPE_EMOTICON ? (l.height = n.ImgHeight * r.width() / n.ImgWidth + "px", l.widht = r.width() + "px") : (l.height = n.ImgHeight, l.width = n.ImgWidth), n.MMImgStyle = l, t.$digest(), i(a.height()), t.$destroy(), a.remove(); else if (s > 40 || 1 == r[0].complete && 0 !== r[0].naturalWidth && s > 0)i(a.height()), t.$destroy(), a.remove(); else {
    ...
    !function () {
        ...
        angular.module("Controllers").controller("chatSenderController", ["$rootScope", "$scope", "$http", "$timeout", "ngDialog", "confFactory", "accountFactory", "contactFactory", "chatFactory", "screenShotFactory", "utilFactory", "mmpop", "stateManageService", "emojiFactory", "reportService", function (e, a, n, i, o, c, r, s, l, d, f, u, m, g, p) {
            function h() {
                var e = "undefined" != typeof F.textContent ? F.textContent : F.innerText, t = F.getElementsByTagName("img").length > 0;
            ...
            function b(e) {
                var t, a, n = "";
                if (window.getSelection)t = window.getSelection(), t.rangeCount > 0 && (a = t.getRangeAt(0).cloneRange(), a.collapse(!0), a.setStart(F, 0), n = a.toString().slice(-e)); else if ((t = document.selection) && "Control" != t.type) {
                    var i;
            ...
            function G(e, t) {
                angular.extend(e, {onQueued: z, onProgress: z, onSuccess: z, onError: z}, t)
            }
                ...
                t.e(3, function (require) {
                    ...
                    try {
                        Y = e.create({
                            ...
                            if (e._data = e._data || {}, /untitled\d+.png/i.test(e.name))G(e, J), e.ToUserName = l.getCurrentUserName(); else if (e.ToUserName || (e.ToUserName = l.getSendFileUsername()), G(e, Q), "gif" !== e.ext.toLowerCase() && !N(e.ext)) {
                                var t = E(e.ext);
                            ...
                            p.report(p.ReportType.uploaderError, {text: "WebUploader 出错", type: e})
                        })
                    } catch (e) {
            ...
            var I, P, U = document.getElementById("caretPosHelper"), A = 0, V = 0, F = document.getElementById("editArea"), x = F.parentNode, D = f.getShareObject("editingContents"), R = !1;
            $(F).on("input", function () {
                M()
            }).on("click", function () {
                M()
            ...
            a.sendClick = function (e) {
                ...
                d.isSupport() ? d.capture({
                    ok: function () {
                        var t = l.createMessage({MsgType: c.MSGTYPE_IMAGE, Type: c.MSGTYPE_IMAGE});
            ...
            a.editAreaKeyup = function (e) {
                ...
                if (u.close(), !a.editAreaCtn.replace(/<br\/?>/g, "").match(/^\s*$/)) {
                    var e = l.createMessage({MsgType: c.MSGTYPE_TEXT, Content: a.editAreaCtn});
            ...
            var Y, B = 20, H = 25, K = {bmp: 1, png: 1, jpeg: 1, jpg: 1, gif: 0}, W = function (e) {
    ...
    !function () {
        ...
        angular.module("Controllers").controller("emojiController", ["$rootScope", "$scope", "$timeout", "emojiFactory", "confFactory", "utilFactory", function (e, t, a, n, i, o) {
            a(function () {
                ...
                var a = e.target;
                if ("A" == a.tagName) {
                    var i = a.innerText || a.textContent, c = a.getAttribute("type");
                    switch (c) {
                        case"qq":
    ...
    !function () {
        ...
        angular.module("Controllers").controller("createChatroomController", ["$rootScope", "$scope", "$timeout", "$state", "$log", "$document", "chatFactory", "contactFactory", "appFactory", "chatroomFactory", "confFactory", "mmpop", "ngDialog", "utilFactory", "stateManageService", "accountFactory", function (e, t, a, n, i, o, c, r, s, l, d, f, u, m, g, p) {
            a(function () {
                ...
                }, !0).result, t.chatroomContacts = r.pickContacts(["chatroom"], {chatroom: {noHeader: !0}}, !0).result
    ...
    !function () {
        ...
        angular.module("Controllers").controller("contextMenuController", ["$rootScope", "$scope", "$state", "contextMenuFactory", "accountFactory", "confFactory", "contactFactory", "ngDialog", "chatroomFactory", "emojiFactory", "utilFactory", "chatFactory", function (e, t, a, n, i, o, c, r, s, l, d, f) {
            ...
            function h(a, n, s, l, u) {
                ...
                var p = g.MMDigest, h = c.getContact(a), M = c.getContact(g.FromUserName);
    ...
    !function () {
        ...
        angular.module("Controllers").controller("editAreaContactListController", ["$scope", "confFactory", "utilFactory", "$timeout", function (e, t, a, n) {
            ...
            function o(e) {
                var t = d + f, a = e * t, n = r.scrollTop;
                if (n > a)return void(r.scrollTop = a);
                var i = a + t + f - r.offsetHeight;
                n < i && (r.scrollTop = i)
            }

            var c = document.getElementById("editArea"), r = document.getElementById("editAreaContactPanel"), s = document.getElementById("caretPosHelper"), l = e.memberList.length - 1, d = 42, f = 10;
        ...
        angular.module("Services").factory("appFactory", ["$http", "$q", "confFactory", "accountFactory", "loginFactory", "utilFactory", "reportService", "mmHttp", function (e, t, a, n, i, o, c, r) {
            var s = {
                globalData: {chatList: []}, init: function () {
                    ...
                    var e = t.defer(),
                        r = this, s = a.API_synccheck + "?" + ["r=" + o.now(),
                        "skey=" + encodeURIComponent(n.getSkey()), "sid=" + encodeURIComponent(n.getSid()), "uin=" + n.getUin(), "deviceid=" + n.getDeviceID(), "synckey=" + encodeURIComponent(n.getFormateSyncCheckKey())].join("&");
                    return window.synccheck && (window.synccheck.selector = 0), $.ajax({
                        ...
                        }) : e.reject(window.synccheck && window.synccheck.selector) : !window.synccheck || "1101" != window.synccheck.retcode && "1102" != window.synccheck.retcode ? window.synccheck && "1100" == window.synccheck.retcode ? i.loginout(0) : (e.reject("syncCheck net error"), c.report(c.ReportType.netError, {
        ...
        angular.module("Services").factory("chatFactory", ["$rootScope", "$timeout", "$http", "$q", "contactFactory", "accountFactory", "emojiFactory", "confFactory", "notificationFactory", "utilFactory", "reportService", "mmHttp", "titleRemind", function ($rootScope, $timeout, $http, $q, contactFactory, accountFactory, emojiFactory, confFactory, notificationFactory, utilFactory, reportService, mmHttp, titleRemind) {
            ...
            var _chatList = [], _chatListInfos = [], _chatMessages = window._chatContent = {}, _currentUserName = "", _addedMsgIdsMap = {}, _msgMap = {}, _sendFileUserName, _currentUnreadMap = {}, service = {
                setCurrentUserName: function (e) {
                    ...
                    if (t && a) {
                        var n = $(t), i = $(a), o = n.attr("data-username"), c = i.attr("data-username");
                        return o && c || utilFactory.reportSendState("sendcheckAttrError"), e || utilFactory.reportSendState("toUserNameNotFound"), o == c && c == e || (c != e && utilFactory.reportSendState("toUserNameConflictNav"), o != e && utilFactory.reportSendState("toUserNameConflictChat"), utilFactory.reportSendState("uiCheckFail"), reportService.report(reportService.ReportType.sendError, {
                            ...
                            values: {chatuser: o, navuser: c, userName: e}
                        }), !1)
                    }
                    ...
                    return _chatListInfos.length = 0, angular.forEach(_chatList, function (a, n) {
                        var i, o = contactFactory.getContact(a), c = {};
                    ...
                    var t, a, n = this, i = utilFactory.htmlDecode(e.MMActualContent), o = "", c = _("ded861c"), r = n.getChatMessage(e.MMPeerUserName);
                    ...
                    function t() {
                        ...
                        var d = notificationFactory.createNotification(utilFactory.clearHtmlStr(a), {body: c, icon: n});
            ...
            var f, u = {}, m = {
                setCurrentContact: function (e) {
                    ...
                    var s = angular.extend({
                        ...
                        NewTopic: n.topic,
                        ChatRoomName: t
                    }, o.getBaseRequest()), d = r.API_webwxupdatechatroom + "?fun=" + e;
            ...
            var u, m = window._contacts = {}, g = window._strangerContacts = {}, p = [], h = [], M = [], v = [], y = window._chatRoomMemberDisplayNames = {}, b = [], C = [], w = [], S = {}, T = {}, N = 0, E = ["fmessage"], G = {
                isSelf: function () {
                    ...
                    if (r.isRoomContact(t.UserName))if (a = t.RemarkName || t.NickName, !a && t.MemberList)for (var n = 0, i = t.MemberList.length; n < i && n < 10; ++n) {
                        a.length > 0 && (a += ", ");
                        var o = t.MemberList[n], c = k.getContact(o.UserName);
                    ...
                    if (this.isRoomContact()) {
                        ...
                        for (var t = 0, a = this.MemberList.length; t < a; t++) {
                            var n = this.MemberList[t].UserName, i = k.getContact(n);
                    ...
                    if (!e)return !0;
                    e = e.toUpperCase();
                    var a = this.RemarkName || "", n = this.RemarkPYQuanPin || "", i = this.NickName || "", o = this.PYQuanPin || "", c = this.Alias || "", r = this.KeyWord || "", s = 0, l = 0;
                ...
                contactChangeFlag: "", setCurrentContact: function (e) {
                    ...
                    return t({
                        ...
                        params: {skey: o.getSkey(), pass_ticket: o.getPassticket(), seq: e, r: r.now()}
                    }).success(function (e) {
                        n.resolve(e)
                    }).error(function (e) {
                    ...
                    for (var n, i, o, c = [], r = this, s = t.all || {}, l = 0; l < e.length; l++)switch (n = e[l], o = t[n] || {}, o = $.extend({}, o, s), n) {
                        ...
                        case"friend":
                            if (i = r.getAllFriendContact(o), i.length > 0) {
                                o.showFriendHeader && c.push({text: _("59d29a3"), type: "header"});
                                var d = "";
                    ...
                    return a && (c = angular.copy(c)), {result: c}
            ...
            var s = {
                getUUID: function () {
                    ...
                    return c({
                        ...
                        r.report(r.ReportType.timing, {timing: {loginEnd: Date.now()}}), a.resolve(e)
                    }).error(function (e) {
                        a.reject("error:" + e)
                    }), a.promise
                }, loginout: function (e) {
            ...
            var f = {
                ...
                queryParser: function () {
                    for (var e = {}, t = location.search.substring(1), a = t.split("&"), n = 0, i = a.length; n < i; n++) {
                        var o = a[n].split("="), c = decodeURIComponent(o[0]);
    ...
    !function () {
        ...
        angular.module("Services").factory("screenShotFactory", ["confFactory", "reportService", function (e, t) {
            ...
            var r = "screencapture", s = "uploader", l = null, d = null;
            return {
                isSupport: function () {
        ...
        angular.module("Services").factory("reportService", ["$http", "$rootScope", "confFactory", "accountFactory", function (e, t, a, n) {
            ...
            function u() {
                $(window).unload(function () {
                    w.unload = g(t), C.push({type: N.runtime, data: w}), !k && C.push({
                        type: N.timing,
                        data: {fullTiming: i()}
        ...
        angular.module("Services").factory("mmHttp", ["$http", "$q", "$timeout", function (e, t, a) {
            ...
            for (var i, o = function (e) {
                ...
                return function (a) {
                    ...
                    var s;
                    return s = r ? n({args: c, method: t, config: o, data: {complete: !1}}) : e[t].apply(e, c)
                }
            }(i);
            return o
        }])
            ...
            var o = [], c = {
                current: null, changeFlag: 0, init: function (e) {
                    ...
                    for (var t = 0, n = e.length; t < n; t++) {
                        var c = e[t];
                        c.HeadImgUrl = c.HeadImgUrl = i.getContactHeadImgUrl({UserName: c.UserName, Skey: a.getSkey()});
                    ...
                    n.bind("paste", function () {
                        ...
                        s && clearTimeout(s), s = setTimeout(function () {
                            ...
                            if (l != -1 && d != -1) {
                                ...
                                var g = r.substring(l, d + 1), p = r.substr(0, l), h = r.substr(l + g.length), M = p.lastIndexOf("<"), v = p.lastIndexOf(">");
    ...
    !function (e) {
        ...
        angular.module("Directives").directive("jplayerDirective", ["$timeout", "utilFactory", function (a, n) {
            return {
                restrict: "A", link: function (i, o, c) {
                    function r() {
                        t.e(2, function (require) {
                            t(281);
                            jQuery(o).jPlayer({
                    ...
                    i.loaded = !1;
                    var d, f = c.lenght || 6100, u = n.browser.msie || n.browser.safari;
            ...
            $get: ["$rootScope", "$document", "$compile", function (e, t, a) {
                var n = {
                    open: function (i) {
                        ...
                        var c;
                        c = e.$new(), angular.extend(c, {imageList: i.imageList, current: i.current});
                        var r = angular.element('<div preview-directive class="J_Preview" current="current" image-list="imageList"></div>'), s = a(r)(c), l = t.find("body").eq(0);
                        l.append(s);
                        var d = {
                            close: function () {
                                var e = s.scope();
    ...
    !function (o, c) {
        ...
        "use strict";
        var a = e.module("ngDialog", []), n = e.element, i = e.isDefined, o = (document.body || document.documentElement).style, c = i(o.animation) || i(o.WebkitAnimation) || i(o.MozAnimation) || i(o.MsAnimation) || i(o.OAnimation), r = "animationend webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend", s = !1;
            ...
            this.$get = ["$document", "$templateCache", "$compile", "$q", "$http", "$rootScope", "$timeout", "$window", "$controller", function (d, f, u, m, g, p, h, M, v) {
                ...
                var b = {
                    ...
                    open: function (c) {
                        ...
                        function s(t) {
                            return t ? e.isString(t) && w.plain ? t : "boolean" != typeof w.cache || w.cache ? f.get(t) || r(t, {cache: !0}) : r(t, {cache: !1}) : "Empty template"
                        }
                        ...
                        return m.when(s(w.template || w.templateUrl)).then(function (t) {
                            ...
                            if (w.controller && (e.isString(w.controller) || e.isArray(w.controller) || e.isFunction(w.controller))) {
                                var r = v(w.controller, {$scope: E, $element: T});
    ...
    angular.module("Directives").directive("mmRepeat", ["$document", "$compile", "$rootScope", function (e, t, a) {
        ...
        function o(e, t, a, o) {
            var c, r, s, l, d, f = t.scroll - a, u = t.scroll + t.visible + a;
        ...
        return {
            restrict: "A", link: function (e, t) {
                function a(e) {
                    var t = n[e];
                    if (t) {
                        var a = t._h, o = t._offsetTop, c = i.scrollTop;
    ...
    angular.module("Directives").directive("navContactDirective", ["$rootScope", "$timeout", "$state", "contactFactory", "stateManageService", "confFactory", "utilFactory", function (e, t, a, n, i, o, c) {
        return {
            restrict: "EA", scope: !0, templateUrl: "navContact.html", link: function (r, s, l) {
                function d(t) {
                    if (i.canDo("navKeydown")) {
                        var a = r.allContacts, n = r.currentContact || a[0], s = n;
                        c.wait(function () {
    ...
    angular.module("Directives").directive("mmPaste", ["$timeout", "utilFactory", "stateManageService", function (e, t, a) {
        return {
            restrict: "EA", scope: {pasteLimit: "=", pasteResetTime: "="}, link: function (n, i, o) {
                var c, r = n.pasteLimit || 1, s = n.pasteResetTime || 200, l = 0;
    ...
    angular.module("Directives").directive("mmActionTrack", ["actionTrack", "utilFactory", function (e, t) {
        ...
        return a.on("resize", function (o) {
            t.fitRun("resize", function () {
                var t = a.height(), o = a.width(), c = [], r = "height-" + (n > t ? "smaller" : "bigger"), s = "width-" + (i > o ? "smaller" : "bigger");
    ...
    !function (e, a, n) {
        ...
        a.module("ngClipboard", []).provider("ngClip", function () {
            ...
            var c = {swfPath: i.path, trustedDomains: ["*"], allowScriptAccess: "always", forceHandCursor: !0};
    ...
    !function () {
        ...
        angular.module("Filters").filter("HTMLEnCode", function (e, t, a) {
            ...
            return function (e) {
                ...
                a.setTime(e);
                var o, c = a.getHours(), r = a.getMinutes(), s = a.getDay(), l = a.getFullYear() % 100, d = a.getMonth() + 1, f = n - e > 604800, u = n - e < 86400 && s == i;
